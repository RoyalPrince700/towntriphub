...
import { Settings, Car, CreditCard, FileText, Phone, Mail } from 'lucide-react';
        ...
        <div className="border-t pt-6 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            <div>
              ...
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">DL-2024-001234</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">License Class</label>
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">Class B</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Expiry Date</label>
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">December 2026</p>
            </div>
        ...
        <div className="border-t pt-6 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            <div>
              ...
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">Sedan</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Vehicle Model</label>
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">Toyota Corolla</p>
            </div>
        ...
        <div className="border-t pt-6 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            <div>
              ...
              <p className="text-gray-900 p-2 bg-gray-50 rounded-lg">John Doe</p>
            </div>
